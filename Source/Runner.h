...
public:
    ...
    static std::vector<ddtype> findRemainingSizes(NodeData* node, std::unordered_map<NodeData*, std::vector<ddtype>>& nodeCompileTimeOutputs, class RunnerInput& inlineInstance, const std::vector<std::span<ddtype>>& outerInputs);
